...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
      <h1 class="text-center mb-5">Form Edit Data Ilmuan Matematika Dunia</h1>
        ...
        <div class="card-body">
          <form action="{{route('ilmuan.update', $ilmuan->id)}}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="nama_ilmuan" value="{{$ilmuan->nama_ilmuan}}" id="nama">
            </div>
            <div class="mb-3">
              <label for="biografi_singkat" class="form-label">Biografi Singkat</label>
              <input type="text" class="form-control" name="biografi_singkat" value="{{$ilmuan->biografi_singkat}}" id="biografi_singkat">
            </div>
